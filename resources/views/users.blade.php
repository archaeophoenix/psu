        ...
        <div class="col-md-12 col-xl-12">
            ...
            <div class="card tbl-card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <button class="btn btn-info" role="button" data-bs-toggle="modal" data-bs-target="#user-edit_add-modal">
                                <i class="ti ti-users-plus f-18"></i> Tambah Pengguna</button>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="mb-0">Hello, I’m Aaron Poole Manufacturing Director based in
                                        international company, Void
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="form-check form-switch d-flex align-items-center justify-content-between p-0">
                                <label class="form-check-label h5 pe-3 mb-0" for="customSwitchemlnot1">Make Contact
                                    Info Public
                                    <span class="text-muted w-75 d-block text-sm f-w-400 mt-2">Means that anyone
                                        viewing your profile will
                            ...
                            <hr class="my-3">
                            <div class="form-check form-switch d-flex align-items-center justify-content-between p-0">
                                <label class="form-check-label h5 pe-3 mb-0" for="customSwitchemlnot2">Available to
                                    hire
                ...
                <div class="modal-footer justify-content-between">
                    <ul class="list-inline me-auto mb-0">
                        <li class="list-inline-item align-bottom">
                            <a href="#" class="avtar avtar-s btn-link-danger w-sm-auto"
